...
export default function Home({ tours, categories }: Props) {
  return (
    <Layout>
      {/* Hero — gradiente oscuro premium */}
      <section className="relative overflow-hidden text-white py-24 md:py-32 px-4" style={{ background: 'linear-gradient(135deg, #0A1628, #0D5C8A)' }}>
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
                ...
                <div className="h-52 relative overflow-hidden">
                  ...
                  {tour.category && (
                    <div className="absolute top-4 left-4">
                      <span className="badge text-white" style={{ background: '#F5882A' }}>
                        {tour.category.name}
                      </span>
                    </div>
                  )}
                ...
                <div className="p-6">
                  ...
                  <div className="flex justify-between items-center pt-4 border-t" style={{ borderColor: '#FAEBD1' }}>
                    <div>
                      ...
                      <span className="block text-xl font-bold" style={{ color: '#0D5C8A' }}>
        ...
        {/* Por que TuresColombia — seccion oscura */}
        ...
        {/* CTA Jaladores — gradiente atardecer */}
        <section className="relative overflow-hidden rounded-card p-8 md:p-12 text-white text-center mb-4" style={{ background: 'linear-gradient(135deg, #F5882A, #FF5F5F)' }}>
          <div className="relative z-10">
            ...
            <p className="text-white/80 mb-8 max-w-lg mx-auto leading-relaxed font-sans" style={{ fontWeight: 300 }}>
              Registrate como Asesor y gana mas del 20% de comision por cada venta. Sin inversion, sin horarios.
            </p>
