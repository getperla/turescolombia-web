      ...
      <main className="max-w-lg mx-auto px-4 py-6">
        ...
        {bookingResult ? (
          ...
          (() => {
            ...
            // /api/bookings/create devuelve paymentUrl (Wompi) — la venta queda
            // PENDIENTE hasta que el cliente complete el pago. Si el cliente no
            // paga, no hay ingreso ni comision (Codex P1 #32). Por eso priorizamos
            // un boton CTA naranja a Wompi por encima del WhatsApp share, y
            // cambiamos el copy de "Reserva confirmada" a "Reserva creada — paga
            // para confirmarla" hasta que el webhook de Wompi marque la sale como
            // pagada.
            ...
            return (
              <div className="text-center">
                <div className="bg-amber-50 border border-amber-200 rounded-2xl p-6 mb-4">
                  ...
                  <h3 className="font-bold text-amber-800 text-xl mb-1">Reserva creada — falta el pago</h3>
                  <p className="text-amber-700 text-sm">Código: <span className="font-mono font-bold">{bookingResult.bookingCode}</span></p>
                  <p className="text-amber-700 text-xs mt-2">Tu cupo se confirma cuando completes el pago.</p>
                </div>
                ...
                {paymentUrl && (
                  <a
                    href={paymentUrl}
                    className="w-full flex items-center justify-center gap-3 text-white font-bold py-4 px-6 rounded-2xl text-lg transition-all shadow-lg mb-3"
                ...
                <a href={whatsappUrl} target="_blank" rel="noopener noreferrer"
                  className="w-full flex items-center justify-center gap-3 bg-[#25D366] hover:bg-[#1DA851] text-white font-bold py-3 px-6 rounded-2xl text-base transition-all shadow-lg mb-3">
                  ...
                  Enviar codigo al cliente por WhatsApp
                </a>
