...
export const mockTours: MockTour[] = [
  ...
  { id: 2, name: 'Tayrona Full Day', slug: 'tayrona-full-day', priceAdult: 180000, coverImageUrl: 'https://images.unsplash.com/photo-1544551763-46a013bb70d5?w=400', totalBookings: 210, avgRating: 4.9, status: 'active', operator: { id: 3, companyName: 'Tayrona Expeditions' } },
  { id: 3, name: 'Ciudad Perdida 4 días', slug: 'ciudad-perdida-4d', priceAdult: 1450000, coverImageUrl: 'https://upqhvogioeztnabpftmq.supabase.co/storage/v1/object/public/tours/ciudad-perdida.jpg', totalBookings: 58, avgRating: 4.7, status: 'active', operator: { id: 2, companyName: 'Sierra Aventuras' } },
  { id: 4, name: 'Minca Cascadas y Café', slug: 'minca-cascadas-cafe', priceAdult: 95000, coverImageUrl: 'https://upqhvogioeztnabpftmq.supabase.co/storage/v1/object/public/tours/minca-cascadas.jpg', totalBookings: 87, avgRating: 4.6, status: 'active', operator: { id: 2, companyName: 'Sierra Aventuras' } },
  { id: 5, name: 'Isla Aguja Snorkel', slug: 'isla-aguja-snorkel', priceAdult: 150000, coverImageUrl: 'https://upqhvogioeztnabpftmq.supabase.co/storage/v1/object/public/tours/isla-aguja.jpg', totalBookings: 112, avgRating: 4.8, status: 'active', operator: { id: 4, companyName: 'Santa Marta Diving' } },
  { id: 6, name: 'Sendero Sierra Nevada', slug: 'sendero-sierra-nevada', priceAdult: 220000, coverImageUrl: 'https://upqhvogioeztnabpftmq.supabase.co/storage/v1/object/public/tours/sierra-nevada.jpg', totalBookings: 34, avgRating: 4.5, status: 'pending_review', operator: { id: 2, companyName: 'Sierra Aventuras' } },
  { id: 7, name: 'Tour Centro Histórico', slug: 'centro-historico', priceAdult: 45000, coverImageUrl: 'https://images.unsplash.com/photo-1518638150340-f706e86654de?w=400', totalBookings: 95, avgRating: 4.4, status: 'active', operator: { id: 1, companyName: 'Tours Caribe SAS' } },
  { id: 8, name: 'Pesca Artesanal Taganga', slug: 'pesca-taganga', priceAdult: 85000, coverImageUrl: 'https://images.unsplash.com/photo-1514222134-b57cbb8ce073?w=400', totalBookings: 42, avgRating: 4.3, status: 'active', operator: { id: 4, companyName: 'Santa Marta Diving' } },
];
