...
export const mockTours: MockTour[] = [
  ...
  { id: 3, name: 'Ciudad Perdida 4 días', slug: 'ciudad-perdida-4d', priceAdult: 1450000, coverImageUrl: 'https://images.unsplash.com/photo-1539650116574-75c0c6d73f6e?w=400', totalBookings: 58, avgRating: 4.7, status: 'active', operator: { id: 2, companyName: 'Sierra Aventuras' } },
  { id: 4, name: 'Minca Cascadas y Café', slug: 'minca-cascadas-cafe', priceAdult: 95000, coverImageUrl: 'https://images.unsplash.com/photo-1580500550469-4f2aaff1a80d?w=400', totalBookings: 87, avgRating: 4.6, status: 'active', operator: { id: 2, companyName: 'Sierra Aventuras' } },
  { id: 5, name: 'Isla Aguja Snorkel', slug: 'isla-aguja-snorkel', priceAdult: 150000, coverImageUrl: 'https://images.unsplash.com/photo-1559554704-d4934ae2c12b?w=400', totalBookings: 112, avgRating: 4.8, status: 'active', operator: { id: 4, companyName: 'Santa Marta Diving' } },
  { id: 6, name: 'Sendero Sierra Nevada', slug: 'sendero-sierra-nevada', priceAdult: 220000, coverImageUrl: 'https://images.unsplash.com/photo-1519681393784-d120267933ba?w=400', totalBookings: 34, avgRating: 4.5, status: 'pending_review', operator: { id: 2, companyName: 'Sierra Aventuras' } },
